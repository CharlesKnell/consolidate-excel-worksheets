...
#         3. Copy this file into the folder containing the .xlsx files to be consolidated/merged.
#         4. Edit the input_file_path and output_file_path to meet your needs. The output_file_path should be
